...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__ram2port__DOT__ram_array__v0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__ram2port__DOT__ram_array__v0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__ram2port__DOT__ram_array__v0;
    // Body
    __Vdly__sigdelay__DOT__address = vlSelf->sigdelay__DOT__address;
    __Vdlyvset__sigdelay__DOT__ram2port__DOT__ram_array__v0 = 0U;
    if (vlSelf->rst) {
    ...
    if (vlSelf->rd_en) {
        vlSelf->dout = vlSelf->sigdelay__DOT__ram2port__DOT__ram_array
            [vlSelf->sigdelay__DOT__address];
    }
    if (vlSelf->wr_en) {
        __Vdlyvval__sigdelay__DOT__ram2port__DOT__ram_array__v0 
            = vlSelf->din;
        __Vdlyvset__sigdelay__DOT__ram2port__DOT__ram_array__v0 = 1U;
        __Vdlyvdim0__sigdelay__DOT__ram2port__DOT__ram_array__v0 
            = (0x1ffU & ((IData)(vlSelf->sigdelay__DOT__address) 
                         + (IData)(vlSelf->offset)));
    }
    vlSelf->sigdelay__DOT__address = __Vdly__sigdelay__DOT__address;
    if (__Vdlyvset__sigdelay__DOT__ram2port__DOT__ram_array__v0) {
        vlSelf->sigdelay__DOT__ram2port__DOT__ram_array[__Vdlyvdim0__sigdelay__DOT__ram2port__DOT__ram_array__v0] 
            = __Vdlyvval__sigdelay__DOT__ram2port__DOT__ram_array__v0;
    }
}
